...
{
    public class GetNurseProfileQueryHandler : IRequestHandler<GetNurseProfileQuery, Result<NurseProfileDto>>
    {
        private readonly AuthenticationDbContext _context;
        private readonly IMapper _mapper;

        public GetNurseProfileQueryHandler(AuthenticationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
